...
exports.loadOscRouterConfigFromEnv = loadOscRouterConfigFromEnv;
exports.loadOscRouterConfigFromEnvAndCli = loadOscRouterConfigFromEnvAndCli;
...
class OSCRouter {
    ...
    constructor(cfg) {
        this.trackerNames = {};
        this.client = new osc_1.OSCTcpClient(cfg.host, cfg.port);
...
function loadOscRouterConfigFromEnv() {
...
function loadOscRouterConfigFromEnvAndCli(cli) {
